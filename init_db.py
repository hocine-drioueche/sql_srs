...
data = {
    ...
    "exercise_name": ["beverages_and_food", "sizes_and_trademarks"],  # Noms des exercices
    "tables": [["beverages", "food_items"], ["sizes", "trademarks"]],  # Tables nécessaires pour chaque exercice
    "last_reviewed": ["1980-01-01", "1970-01-01"],  # Dates de dernière révision initiales
}
